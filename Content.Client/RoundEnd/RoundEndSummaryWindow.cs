...
using Content.Client._Cats.StatsBoard;
...
namespace Content.Client.RoundEnd
{
    public sealed class RoundEndSummaryWindow : DefaultWindow
    {
        ...
        public RoundEndSummaryWindow(string gm, string roundEnd, TimeSpan roundTimeSpan, int roundId,
            RoundEndMessageEvent.RoundEndPlayerInfo[] info, string roundEndStats, SharedStatisticEntry[] statisticEntries, IEntityManager entityManager, ISharedPlayerManager playerManager) // Cats-starbound
        {
            _entityManager = entityManager;
            _playerManager = playerManager; // Cats-starbound

            MinSize = SetSize = new Vector2(700, 600); // Cats-starbound
            ...
            roundEndTabs.AddChild(MakeRoundEndStatsTab(roundEndStats)); // Cats-starbound
            roundEndTabs.AddChild(MakeRoundEndMyStatsTab(statisticEntries)); // Cats-starbound
