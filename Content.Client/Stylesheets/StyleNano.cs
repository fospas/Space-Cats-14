...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public const string StyleClassLobbyBackground = "LobbyBackground"; // cats
        public const string StyleClassPanelBackground = "PanelBackground"; // cats
        ...
        public StyleNano(IResourceCache resCache) : base(resCache)
        {
            ...
            var tabContainerPanelTex = resCache.GetTexture("/Textures/_Cats/Interface/Nano/lobby.png"); // cats
...
// ListContainer
                ...
                Element<PanelContainer>().Class(ClassAngleRect)
                    ...
                    .Prop(Control.StylePropertyModulateSelf, Color.FromHex("#0f0f0f")), // cats
