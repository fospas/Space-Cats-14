...
alert-level-epsilon-instructions = Все контракты расторгнуты.йствия кода.
alert-level-sierra = Сиерра
alert-level-sierra-announcement = Центральное командование объявило полную изоляцию станции, обнаружена серьёзная угроза на станции. Всем необходимо сохранять спокойствие и проследовать в свой отдел для получения указаний от глав. Отделу службы безопасности требуется усилить патрули, рекомендуется использование летального оружия. При попытке сбежать с станции, все шаттлы и корабли будут сбиты.
alert-level-sierra-instructions = Всем необходимо сохранять спокойствие и проследовать в свой отдел для получения указаний от глав.
