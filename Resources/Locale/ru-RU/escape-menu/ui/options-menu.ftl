...
ui-options-postprocess-tooltip = Если включено, будут отображаться косметические эффекты постобработки, такие как  
                                 аддитивное освещение. Это не управляет эффектами постобработки,  
                                 которые влияют на игру или имеют какое-либо значение для игрового процесса.
