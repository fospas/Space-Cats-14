...
ghost-gui-respawn-button-denied = Возрождение ({$time})
ghost-gui-respawn-button-allowed = Возродиться
...
ghost-respawn-rules-window-rules =
    заглушка
    еще одна заглушка
    еще немного заглушки
    с добавлением заглушки
    может быть, еще немного заглушки
    можно мне еще заглушку в придачу