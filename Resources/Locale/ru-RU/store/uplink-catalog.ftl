...
uplink-energy-dome-desc = Персональный генератор щита, который защищает носителя от лазеров и пуль, но не позволяет использовать дальнобойное оружие. В комплекте с небольшой батареей.
# Explosives
